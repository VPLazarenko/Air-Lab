      ...
      <footer className="bg-black text-white py-8 mt-16">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Company Info */}
            <div>
              <h3 className="text-xl font-bold mb-4">Initiology AI Systems</h3>
              <p className="text-gray-300 mb-4">
                Передовые решения для управления документами на базе искусственного интеллекта
              </p>
              <div className="flex items-center gap-4">
                <img src={logoPath} alt="Initiology AI" className="w-12 h-12 rounded-lg" />
                <span className="text-sm text-gray-400">Версия 2.0</span>
              </div>
            </div>

            {/* Downloads */}
            <div>
              <h3 className="text-lg font-semibold mb-4">Загрузки</h3>
              <div className="space-y-3">
                ...
                <div className="text-xs text-gray-400 ml-2">
                  Лицензионный ключ: <code className="bg-gray-800 px-2 py-1 rounded">0403198422061962</code>
                </div>
                <DownloadButton 
                  variant="macos"
                  className="w-full justify-start bg-gray-800 hover:bg-gray-700 text-white border-gray-600"
